//
//  scoreHyperactivityViewController.swift
//  ADHDbook
//
...
class scoreHyperactivityViewController : UIViewController {
    @IBOutlet weak var scoreHyperactivityLabel: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        scoreHyperactivityLabel.text = "Yesの数 : \(correct) 問"
